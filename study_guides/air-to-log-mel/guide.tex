...
regrouped the way the ear groups them, with a log on top). Each
arrives with its series, and with it a transition page that says why
the next station needs exactly what the last one built.
