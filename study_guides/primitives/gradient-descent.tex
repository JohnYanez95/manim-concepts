...
\anchor{014.basin.sqrt11}$ already crosses the hilltop on its first
hop, and from $w_0 = 4$ the hop clears both valleys entirely
($4 \to -2$, settling at $-1$) — a jump the parent series makes a
beat of, because no rolling ball could copy it) — but a walk started \emph{exactly} at $0$ never
