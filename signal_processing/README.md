...
- [ ] [Wage et al., "The Signals and Systems Concept Inventory" (2002)](https://peer.asee.org/the-signals-and-systems-concept-inventory.pdf)
      ...
      Wright, ASEE 2002: why no spectrum here appears without its
      waveform.
...
- **Mel** — a matrix of triangles regrouping Whisper's 201 rows into
  80, a log on top: the log-mel spectrogram. The first honest customer
  for a `linear_algebra/` topic: the bank is a projection onto probes,
  the mel filterbank a matrix.
