...
- **Other kernels** — the first difference [1, −1] as a high-pass (gains
  0, 0.77, 1.41, 1.85, 2 on this grid), [1, 2, 1]/4 as the ½ ½ window
  squared: pinned in plan 020, not on screen.
