...
- **"Divide out / drop what doesn't matter" in WARM**: cancelled
  ...
  and 4000 Hz outputs and their after-bars WARM: "0.14 as tall, and
  upside down — the sign flipped"), carried into
...
- **The closing `WhenToUseIt` mapping scene**: same layout in eight
  ...
  under "built here — next on the road: the window behind every frame,
